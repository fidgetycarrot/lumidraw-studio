...
const EXTENSION_VERSION = '0.38.0'
...
function realSetup(ctx) {
  ...
  // ------------------------------------------------------------------ markup
  dom.inject('body', `
    <button class="ld-launcher" title="LumiDraw Studio v0.38.0" aria-label="LumiDraw Studio v0.38.0">
    ...
    <div class="ld-panel">
      <div class="ld-head">
        <span class="ld-head-title">LumiDraw <small style="font-weight:400;opacity:.65">v0.38.0</small></span>
          ...
          <div class="ld-persona-editor ld-card" style="display:none">
            ...
            <div class="ld-profile-grid" style="margin-top:7px">
              <div><span class="ld-label">Anchor / name</span><input class="ld-persona-ed-anchor" placeholder="Eric" /></div></div>
                  <div><span class="ld-label">Name in prompts (optional)</span><input class="ld-persona-ed-promptname" placeholder="Fanny Price" /><div class="ld-hint">Use when the name reads as something else to the image model — "Fanny" is booru slang for a body part. A full name usually fixes it.</div>
            ...
            <details class="ld-profile-block" open>
              ...
              <div class="ld-profile-fields">
                ...
                <div class="ld-profile-grid">
                  ...
                  <div><span class="ld-label">Name in prompts (optional)</span><input class="ld-ed-char-promptname" placeholder="Fanny Price" /><div class="ld-hint">Use when the name reads as something else to the image model — "Fanny" is booru slang for a body part. A full name usually fixes it.</div>
            ...
            <details class="ld-profile-block">
              ...
              <div class="ld-profile-fields">
                ...
                <div class="ld-profile-grid">
                  ...
                  <div><span class="ld-label">Name in prompts (optional)</span><input class="ld-ed-persona-promptname" placeholder="Fanny Price" /><div class="ld-hint">Use when the name reads as something else to the image model — "Fanny" is booru slang for a body part. A full name usually fixes it.</div>
