...
function realSetup(ctx) {
  ...
  // ------------------------------------------------------------------ markup
  dom.inject('body', `
    <button class="ld-launcher" title="LumiDraw Studio v0.33.2" aria-label="LumiDraw Studio v0.33.2">
    ...
    <div class="ld-panel">
      <div class="ld-head">
        <span class="ld-head-title">LumiDraw <small style="font-weight:400;opacity:.65">v0.33.2</small></span>
