...
const EXTENSION_VERSION = '0.26.0'
...
function realSetup(ctx) {
  ...
  // ------------------------------------------------------------------ markup
  dom.inject('body', `
    <button class="ld-launcher" title="LumiDraw Studio v0.26.0" aria-label="LumiDraw Studio v0.26.0">
    ...
    <div class="ld-panel">
      <div class="ld-head">
        <span class="ld-head-title">LumiDraw <small style="font-weight:400;opacity:.65">v0.26.0</small></span>
