...
function realSetup(ctx) {
  ...
  // ------------------------------------------------------------------ markup
  dom.inject('body', `
    <button class="ld-launcher" title="LumiDraw Studio v0.22.1" aria-label="LumiDraw Studio v0.22.1">
    ...
    <div class="ld-panel">
      <div class="ld-head">
        <span class="ld-head-title">LumiDraw <small style="font-weight:400;opacity:.65">v0.22.1</small></span>
